...
for VIEWS_TYPE in "${VIEWS[@]}"; do
    ...
    for DECODER_ONLY in "${TRAIN_DECODER_ONLY[@]}"; do
        ...
        CHECKPOINT="${PRETRAINED_MODEL}/ckpt_pretrain_ep0026_step0040000.pth" \
        ...
        #./experiments/attack_and_test_transformer.sh 1 2 1 false 1 1 false 1 false false false v2-1-z_no_no-pgd_no_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${VIEWS_TYPE}-full-dec_only-${DECODER_ONLY} $TRANSFORM_NAME 0.5 0.5 0.01 $DATASET_NAME 1 $FINAL_MODEL $NUM_REPLACE 0 true true false "Best_F1"
        ...
        #./experiments/attack_and_test_transformer.sh 1 2 1 false 1 1 true 3 false false false v2-3-z_rand_1-pgd_3_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${VIEWS_TYPE}-full-dec_only-${DECODER_ONLY} $TRANSFORM_NAME 0.5 0.5 0.01 $DATASET_NAME 1 $FINAL_MODEL $NUM_REPLACE 0 true true false "Best_F1"
        ./experiments/attack_and_test_transformer.sh 1 2 1 false 1 1 true 3 false false false v2-3-z_rand_1-rand_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${VIEWS_TYPE}-full-dec_only-${DECODER_ONLY} $TRANSFORM_NAME 0.5 0.5 0.01 $DATASET_NAME 1 $FINAL_MODEL $NUM_REPLACE 0 true true false "Best_F1"
