...
MODEL_SHORT_NAME="contracode-at"
MODEL_NAME="final-models/seq2seq/code_completion/sri/py150/finetuned_sri_random_online_transforms.Replace_decoder-only-false-epochs-1-0.4"
FINETUNED_MODEL="contracode-at"
EXPT_NAME="v2-3-z_rand_1-pgd_3-no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-$TRANSFORM_NAME-$FINETUNED_MODEL-AT"

NUM_REPLACE=1500
bash ./experiments/adv_train_seq2seq_online_codecompletion.sh 0 2 1 false 1 1 true 3 false false false $EXPT_NAME $TRANSFORM_NAME 0.5 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 false true false "Best_F1"
