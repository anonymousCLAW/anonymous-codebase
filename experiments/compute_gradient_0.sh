...
MODEL_NAME="final-models/seq2seq/v2-3-z_rand_2-pgd_3-no-transforms.Combined-py150-transforms.Combined-finetuned_sri_hidden_identity_adversarial_online_transforms.Combined_decoder-only-false-epochs-1-AT/sri/py150/transforms.Combined/adversarial/"
NUM_REPLACE=1500

# no attack, all sites
# ./experiments/attack_and_test_seq2seq.sh 0 2 1 false 1 0 false 1 false true false v2-1-z_rand_all-pgd_rand_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL $TRANSFORM_NAME 0.5 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0

# # no attack
#./experiments/attack_and_test_seq2seq.sh 0 2 1 false 1 1 false 1 false false false v2-1-z_no_no-pgd_no_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-$MODEL_SHORT_NAME $TRANSFORM_NAME 0.5 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true

# # no attack, random replace
# ./experiments/compute_gradient.sh 0 2 1 false 1 0 false 1 false true false v2-1-z_rand_all-pgd_rand_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME} $TRANSFORM_NAME 0.5 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Best_F1"
./experiments/compute_gradient.sh 0 2 1 false 1 1 true 1 false false false v2-3-z_rand_1-pgd_3_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME} $TRANSFORM_NAME 0.5 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Best_F1"
# ############## without smoothing ############
# # z-1 sites rand, pgd 3
#./experiments/attack_and_test_seq2seq.sh 0 2 1 false 1 1 true 3 false false false v2-3-z_rand_1-pgd_3_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-$MODEL_SHORT_NAME $TRANSFORM_NAME 0.5 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 1 true
