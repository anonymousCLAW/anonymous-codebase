...
# MODEL_NAME="/final-models/seq2seq/code_completion/v2-3-z_rand_1-pgd_3-no-transforms.Replace-py150-transforms.Replace-finetuned_sri_adversarial_online_transforms.Replace_decoder-only-false-epochs-1-0.4-AT-lamb-0.4/sri/py150/transforms.Replace/adversarial"
NUM_REPLACE=1500

# no attack, all sites
# ./experiments/attack_and_test_seq2seq_codeclone.sh 1 2 1 false 1 0 false 1 false true false v2-1-z_rand_all-pgd_rand_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME} $TRANSFORM_NAME 0.5 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Best_F1"
lr=0.5
./experiments/attack_and_test_seq2seq_codeclone.sh 0 2 1 false 1 1 true 1 false false false v2-3-z_rand_1-pgd_1_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME}-${lr} $TRANSFORM_NAME ${lr} 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Best_F1"
lr=0.05
./experiments/attack_and_test_seq2seq_codeclone.sh 0 2 1 false 1 1 true 1 false false false v2-3-z_rand_1-pgd_1_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME}-${lr} $TRANSFORM_NAME ${lr} 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Best_F1"
lr=0.1
./experiments/attack_and_test_seq2seq_codeclone.sh 0 2 1 false 1 1 true 1 false false false v2-3-z_rand_1-pgd_1_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME}-${lr} $TRANSFORM_NAME ${lr} 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Best_F1"
